...
spec = do
  ...
  describe "addCommand" $ do
    ...
    it "Two Immediate" $
      ...
      Computer [1, 9, 10, 19, 2, 3, 11, 0, 99, 30, 40, 50] [] 4 [] 0
  describe "addCommand" $ do
    it "Two Pointers" $
      mulCommand
    ...
    it "Two Immediate" $
      mulCommand
        (Computer [2, 9, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [] 0 [] 0)
        [Immediate, Immediate, Immediate] `shouldBe`
      Computer [2, 9, 10, 90, 2, 3, 11, 0, 99, 30, 40, 50] [] 4 [] 0
  describe "inputCommand" $ do
    it "example #1" $
      inputCommand
        (Computer [4, 5, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [4, 5, 10, 3, 2, 1, 11, 0, 99, 30, 40, 50] [] 2 [] 0
    it "example #1" $
      inputCommand
        (Computer [4, 3, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [4, 3, 10, 1, 2, 3, 11, 0, 99, 30, 40, 50] [] 2 [] 0
    it "multiple input value" $
      inputCommand
        (Computer [4, 3, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1, 2] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [4, 3, 10, 1, 2, 3, 11, 0, 99, 30, 40, 50] [2] 2 [] 0
  describe "outputCommand" $ do
    it "example #1" $
      outputCommand
        (Computer [3, 5, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [3, 5, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 2 [3] 0
    it "example #1" $
      outputCommand
        (Computer [4, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [4, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 2 [10] 0
  describe "jumpIfTrueCommand" $ do
    ...
    it "no jump pointer" $
      jumpIfTrueCommand
        (Computer [5, 2, 0, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [5, 2, 0, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 3 [] 0
    it "jump immediate" $
      jumpIfTrueCommand
        (Computer [1105, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Immediate, Immediate, Pointer] `shouldBe`
      Computer [1105, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 10 [] 0
    it "no jump immediate" $
      jumpIfTrueCommand
        (Computer [1105, 0, 4, 3, 0, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Immediate, Immediate, Pointer] `shouldBe`
      Computer [1105, 0, 4, 3, 0, 3, 11, 0, 99, 30, 40, 50] [1] 3 [] 0
  describe "jumpIfFalseCommand" $ do
    it "jump pointer" $
      jumpIfFalseCommand
        (Computer [6, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [6, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 3 [] 0
    it "no jump pointer" $
      jumpIfFalseCommand
        (Computer [6, 2, 0, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Pointer, Pointer, Pointer] `shouldBe`
      Computer [6, 2, 0, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 6 [] 0
    it "jump immediate" $
      jumpIfFalseCommand
        (Computer [1106, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Immediate, Immediate, Pointer] `shouldBe`
      Computer [1106, 2, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 3 [] 0
    it "no jump immediate" $
      jumpIfFalseCommand
        (Computer [1106, 0, 0, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0)
        [Immediate, Immediate, Pointer] `shouldBe`
      Computer [1106, 0, 0, 3, 2, 3, 11, 0, 99, 30, 40, 50] [1] 0 [] 0
