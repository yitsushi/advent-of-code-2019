...
spec =
  describe "parseRecipe" $ do
    describe "example1" $ do
      ...
      it "has FUEL" $
        Map.lookup "FUEL" database `shouldBe`
        Just
          (Resource
             { rName = "FUEL"
             , rQuantity = 1
             , rIngredients =
                 [ ResourceIngredient {riName = "A", riQuantity = 7}
                 , ResourceIngredient {riName = "E", riQuantity = 1}
                 ]
             })
      it "has A" $
        Map.lookup "A" database `shouldBe`
        Just
          (Resource
             { rName = "A"
             , rQuantity = 10
             , rIngredients =
                 [ResourceIngredient {riName = "ORE", riQuantity = 10}]
             })
      ...
      it "has FUEL" $
        ...
        Just
          (Resource
             ...
             , rQuantity = 1
             , rIngredients =
                 [ ResourceIngredient {riName = "AB", riQuantity = 2}
      ...
      it "has A" $
        ...
        Just
          (Resource
             ...
             , rQuantity = 2
             , rIngredients =
                 [ResourceIngredient {riName = "ORE", riQuantity = 9}]
             })
